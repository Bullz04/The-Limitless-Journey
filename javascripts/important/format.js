...
function format(amount, places = 3, placesUnderLimit = 1, notation = player.options.notation, limit = 1e3) {
    ...
    if (placesUnderLimit >= player.options.maxPrecisionUnder1000) placesUnderLimit = Math.min(placesUnderLimit, player.options.maxPrecisionUnder1000)
    ...
    */
    ...
    if (amount.lt(limit)) return amount.toNumber().toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:placesUnderLimit})

    if (notation === "scientific") {
        if (power.gte("1e15")) return "e" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "scientific")
        if (power.gte("1e9")) return lol.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "e" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "scientific")
        return lol.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "e" + power.toNumber().toLocaleString("en-US")
    }

    if (notation === "engineering") {
        if (power.gte("1e15")) return "e" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "engineering")
        if (power.gte("1e9")) return lolAntime.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "e" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "engineering")
        return lolAntime.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "e" + (powerAntime.times(3)).toNumber().toLocaleString("en-US")
    }
    ...
    if (notation === "true-scientific") {
        ...
        if (power.gte("1e9")) return lol.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places})  + "&times;10<sup>" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "true-scientific") + "</sup>"
        return lol.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "&times;10<sup>" + power.toNumber().toLocaleString("en-US") + "</sup>"
    }
    ...
    if (notation === "true-engineering") {
        ...
        if (power.gte("1e9")) return lolAntime.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "&times;10<sup>" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "true-engineering") + "</sup>"
        return lolAntime.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "&times;10<sup>" + powerAntime.times(3).toNumber().toLocaleString("en-US") + "</sup>"
    }
    ...
    if (notation === "standard") {
        ...
        if (power.gte(3000000003)) return lol.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + "e" + format(OmegaNum.log10(amount), 5, placesUnderLimit, "standard")
        if (power.lt(33)) return lolAntime.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + " " + tempShortSuffixes[Math.floor((power.toNumber()) / 3) % 13];
        return lolAntime.toLocaleString("en-US", {minimumFractionDigits:0,maximumFractionDigits:places}) + " " + result3 + ( power.gte(3000003) ? (result+result2 == "" ? "" : "-") : "") + result2 + ( power.gte(3003) ? (result == "" ? "" : "-") : "") + result
    }
